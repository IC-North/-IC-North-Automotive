...
def build_message(subject: str, body_text: str, sender: str, recipient: str,
    ...
    # Add attachments to EmailMessage object for interface compatibility
    if attachments:
...
def send_email(msg: EmailMessage) -> str:
    ...
    data = {
        ...
        "content": [{
            "type": "text/plain",
            "value": msg.get_body(preferencelist=('plain','html')).get_content() if msg.get_body() else ""
        }],
    }
