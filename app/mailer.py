...
def build_message(subject, body_text, sender, recipients_csv, attachments=None) -> EmailMessage:
    msg = EmailMessage()
    msg['Subject']=subject; msg['From']=sender; msg['To']=recipients_csv
...
def send_email(msg: EmailMessage) -> str:
    ...
    data={
      "personalizations":[{"to":[{"email":e} for e in to_emails],"subject":msg.get('Subject','')}],
